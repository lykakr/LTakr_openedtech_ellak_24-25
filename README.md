...
---
 ...
 - Η αυτοματοποίηση  θα μπορεί  να επεκταθεί σε μεγαλύτερο **αριθμό Ρομπότ-Ζωγράφων , αισθητήρων και συσκευών** 

 - Ο κεντρικός σταθμός θα αρχειοθετεί και θα οργανώνει  **" βιβλιοθήκη απεικονίσεων και σενάρια αυτοματισμού"**  τις οποίες θα ενεργοποιεί και θα αποστέλλει  κατά τη βούληση του χειριστή
...
Το σύστημα που προτείνεται είναι αρθρωτό και μπορεί να υλοποιηθεί με κλιμακούμενες διαμορφώσεις. Το προϋπολογιζόμενο  **κόστος είναι 290**, στο προτεινόμενο  πλήρες σύστημα

ΥΚΙΚΑ

* 1 τεμ. Χ  3D Νήμα PLA 1.75mm  1kg

* 1 τεμ. Χ Raspberry Pi 5 kit	
* 1 τεμ. Χ Ελεγκτής- Raspberry Pi Zero 2 W	
* 1 τεμ. Χ Ελεγκτής ESP32 kit	
* 1 τεμ. Χ Σερβοκινητήρας - Servo Micro 1.8kg.cm Metal Gears 	
* 2 τεμ. Χ Βηματικός Κινητήρας - Stepper Motors	
* 1 τεμ. Χ Οδηγός Κινητήρα - Dual Motor Driver 	
* 1 τεμ. Χ Bluetooth Module for Arduino - HC05	
* 2 τεμ. Χ Αντλία micro	
...
* Jumper Cables, Dupont Terminal SET	
* Διάφορα μικροηλεκτρονικά εξαρτήματα, 
καλώδια, κτλ	
* Βίδες Παξιμάδια- Bolts & Nuts Assortment 	
* Ξυλεία ( ή και μακετόχαρτο)	
